...
## What's the difference between _normalized_ data and _absolute_ data?
...
Our [Interest endpoint](https://glimpse-enterprise.readme.io/reference/get_v1-interest) returns this normalized data, directly as Google Trends shows it in their web app. Our [Interest_enriched endpoint](https://glimpse-enterprise.readme.io/reference/interest-enriched) returns the datapoints as absolute search volume numbers, in addition to other metrics like YoY growth and MoM growth.
