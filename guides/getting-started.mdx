...
\<button style={{ backgroundColor: '#2B32FF', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '9999px', fontSize: '16px', fontFamily: 'sans-serif', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px' }}\> Get an API Key \<span style={{ display: 'inline-block', transform: 'translateY(1px)' }}\>➔\</span\>\</button\>
